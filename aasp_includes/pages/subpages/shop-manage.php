...
?>
<?php $page = new page; ?>
<div class="box_right_title"><?php echo $page->titleLink(); ?> &raquo; Gerenciar os itens</div>
<table width="100%">
        <tr valign="top">
             <td style="text-align: left; width: 300px;"><h3>Modificar um único item</h3>
             <p/>
             ID<br/>
             ...
             <input type="submit" value="Atualizar" onclick="modSingleItem()"/>
             <input type="submit" value="Remover" onclick="delSingleItem()"/>
             </td>
             <td style="text-align: left; width: 300px;"><h3>Modificar vários itens</h3>
             <p/>
             Nível dos itens<br/>
             ...
             <input type="submit" value="Atualizar" onclick="modMultiItem()"/>
             <input type="submit" value="Remover" onclick="delMultiItem()"/>
             </td>
        </tr>
</table>